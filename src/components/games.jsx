...
const ExploreGames = () => {
  ...
  const navItems = [
    ...
    { key: 'game', href: '/game', icon: Gamepad2, text: t.nav.game },
    { key: 'quizzes', href: '/quiz', icon: HelpCircle, text: t.nav.quizzes },
    { key: 'about', href: '/aboutus', icon: Info, text: t.nav.about }
  ];
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <a href="/aboutus" className={`${themeClasses.textSecondary} hover:${themeClasses.link.split(' ')[0]} px-3 py-2 rounded-md text-sm font-medium flex items-center transition-colors duration-200`}>
